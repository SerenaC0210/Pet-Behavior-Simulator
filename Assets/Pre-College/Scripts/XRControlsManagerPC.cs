...
/*
 * This is the Pre-College (PC) version of the `XRControlsManager` script.
 * It interacts with `UpdateUI`s instead of `InterfaceUpdate`s.
 */

public class XRControlsManagerPC : MonoBehaviour
{
    ...
    public void UpdateValues()
    {
        ...
        UpdateUI[] interfaces = FindObjectsByType<UpdateUI>(
            FindObjectsInactive.Include,
            FindObjectsSortMode.None
        );

        foreach (UpdateUI iface in interfaces)
            iface.UpdateValues();
    }
